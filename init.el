...
(custom-set-variables
 ...
 '(package-selected-packages
   '(python-isort auto-rename-tag ac-html which-key yasnippet-snippets all-the-icons flymake-codespell corfu jedi python-django vterm org-modern yasnippet centaur-tabs magit spacemacs-theme gnu-elpa-keyring-update evil-leader evil))
 '(text-mode-hook

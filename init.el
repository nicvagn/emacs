...
;;; code:
"Set up package managment and config use-package."
;; add our lisp dir to load path
(setq load-path (append  "/home/nrv/.config/emacs/lisp" load-path))
...
(custom-set-faces
 ...
 '(isearch ((t (:background "thistle" :foreground "dark red"))))
...
;; treesit.el is an intelligent way to choose between a default mode, such as python-mode, and it’s tree-sitter enhanced version, python-ts-mode, automatically.
...
(provide 'init.el)
;;; Local Variables:
;; byte-compile-warnings: (not free-vars yas-snippet-dir)
;; End:
;;; init.el ends here

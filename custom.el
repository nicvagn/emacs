...
(custom-set-variables
 ...
 '(package-selected-packages
   '(all-the-icons-dired all-the-icons-gnus all-the-icons-nerd-fonts avy
                         ...
                         flyspell-correct format-all jarchive
                         kind-icon magit marginalia markdown-mode
                         neotree nerd-icons-corfu orderless
                         php-cs-fixer php-ts-mode python-black
                         qml-mode queue rust-mode sbt-mode scad-mode
                         scala-mode shfmt tramp tramp-theme
                         transient-dwim treesit-auto treesit-fallback
                         vertico vterm web-mode yasnippet-capf))
